...
| `.ed-badge` + `#edCheckSheet` | Beweis-Badges sind KNÖPFE (M71): Tippen öffnet die Tafel unten im Editor – Titel mit Zeichen, ein Satzpaar „was geprüft wird / was ein Rot bedeutet", das Detail in Klartext und „👁 Zeigen". Die gezeigte Zelle bekommt einen bernsteinfarbenen Rahmen (`--warning`), der bleibt, bis man das Feld anfasst |
