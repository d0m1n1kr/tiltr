...
export const de = {
  ...
  'ed.help.softlock': 'Von JEDER erreichbaren Stelle bleibt das Ziel erreichbar. Rot heißt: Ab der genannten Zelle kommt man nicht mehr hin – typisch ein Transporter in eine Ebene ohne Rückweg, eine Einbahn-Strömung oder eine Tür, die wieder zufällt.',
