...
export const de = {
  ...
  'ed.opensMin': 'Mindestens eine Tür',
  'ed.f.tune': 'Klang-Tor',
  ...
  'el.drain.title': 'Zehrfeld',
  'el.drain.desc': 'Ein Feld, das deine Echo-Pings frisst: Jede Überfahrt kostet so viele, wie darauf steht – und wer noch einmal hinüberrollt, zahlt noch einmal. Damit kostet eine Abkürzung nicht Zeit, sondern SICHT. Signatur: ein tiefes, saugendes Zehren in der Nähe, ein schlürfender Abwärtston beim Zahlen.',
  'st.drain': '🕳 Zehrfeld: −{n} Ping',
  'ed.f.drainCost': 'Kosten (Pings)',
  ...
  'cast.text': 'Das Video entsteht aus dem Mitschnitt: Der Lauf wird noch einmal abgespielt und dabei mit Ton aufgezeichnet – in Echtzeit, also so lange, wie er gedauert hat. Bildschirm dabei nicht verlassen.',
  'cast.speed': 'Tempo',
  'cast.light': 'Licht',
  'cast.asPlayed': 'wie gespielt',
  'cast.bright': 'hell',
  'cast.go': '● Aufnehmen',
  'cast.rec': '● REC',
