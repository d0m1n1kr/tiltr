...
export const en: Dict = {
  ...
  'promo.share': '📣 Spread the word',
  'promo.title': 'tiltr – the invisible maze',
  'promo.text': 'One ball, one invisible maze: you hear the walls instead of seeing them. Headphones on, tilt your phone – the echo ping shows you the way. Free in the browser, playable offline, no account.',
  'promo.copied': 'Text and link copied 📋',
  'bk.save': '💾 Back up',
  'bk.load': '📂 Restore',
  ...
  'ed.together': 'Co-op win',
  'ed.together.each': 'Each on their own',
  'ed.together.both': 'Arrive together',
  'ed.togetherHint': 'You only win while both of you are in your goals at the same time.',
  'ed.marks': 'Waypoints per player',
  'ed.cols': 'Columns',
  'ed.rows': 'Rows',
  'ed.reroll': 'Reroll maze',
  'ed.clearWalls': 'Clear all walls',
  'ed.clearWallsAsk': 'Clear all walls?',
  'ed.clearedWalls': '{n} walls removed',
  ...
  'ed.f.latch': 'After opening',
  'ed.latch.close': 'closes again',
  'ed.latch.stay': 'stays open',
  ...
  'ed.opensMin': 'At least one door',
  'ed.f.tune': 'Sound gate',
  ...
  'ed.f.pitch': 'Given tone',
  'ed.pitch.off': 'off (the partner sounds it)',
  'ed.pitch.base': 'Root',
  'ed.pitch.fifth': 'Fifth',
  'ed.pitch.octave': 'Octave',
  'ed.pitchHint': 'With a given tone the counter-tone sounds from the field itself – so the gate can be tuned ALONE. The door then needs „stays open", otherwise you would still be on the field while rolling through.',
  'ed.resonanceHint': 'Resonance field: the bowl holds your ball, the tilt direction tunes the tone (up = root, down = octave). The gate opens once BOTH tones sit in the interval – place two fields with the same interval and set the door to „all openers + stays open".',
  'ed.f.opens': 'Opens doors',
  'ed.f.id': 'Door ID',
  ...
  'el.drain.title': 'Drain field',
  'el.drain.desc': 'A field that eats your echo pings: every crossing costs as many as the number written on it — and rolling across again costs again. A shortcut here does not cost time, it costs SIGHT. Signature: a deep, sucking drag when you are near, a slurping downward tone when you pay.',
  'st.drain': '🕳 Drain field: −{n} ping',
  'ed.f.drainCost': 'Cost (pings)',
  ...
  'hud.partnerWaits': '◎ Partner waiting',
  'hud.mark': 'Drop / pick up waypoint (m)',
  'hud.markEmpty': 'No waypoint left – pick one up again.',
  ...
  'mp.needsUpdate': 'Your partner needs a newer version of tiltr for this level.',
  ...
  'el.bell.desc': 'Roll over it and it rings: a bright chime that lingers for four seconds – and for as long as it does, every listener runs to the bell instead of to you. Distract instead of avoid. Ping answer: a short bell blip. With two players it rings for BOTH: your partner’s listeners come along too.',
  ...
  'el.resonance.title': 'Resonance field & duet',
  'el.resonance.desc':
    'A pressure plate that cradles your ball like a bowl – and the tilt becomes a tuning knob: up is the root, down the fifth. With two players two fields sound against each other; once the interval sits (unison or fifth), the gate swings open. Alone it cannot be played.',
  ...
  'st.tuneGiven':
    '🎵 The field sets the tone – tune {int} to it. A short nudge in one direction, and the tone stays.',
  'st.tuneOpen':
  ...
  'cast.text': 'The video is made from the recording: the run is replayed and captured with sound – in real time, so it takes as long as the run did. Keep the screen open meanwhile.',
  'cast.speed': 'Speed',
  'cast.light': 'Light',
  'cast.asPlayed': 'as played',
  'cast.bright': 'bright',
  'cast.go': '● Record',
  'cast.rec': '● REC',
  ...
  'mp.partnerTone': '🎵 Your partner is standing on their resonance field.',
  'mp.partnerMark': '📍 Your partner dropped a waypoint.',
  ...
  'mp.rendezvousTime': 'Arrived together after {team}.',
