...
export const es: Dict = {
  ...
  'ed.partner': 'Compañero en la vista previa',
  'ed.partner.holds': 'mantiene todas las placas',
  'ed.partner.none': 'ausente',
  'st.partnerHolds': 'Vista previa: el compañero mantiene todas las placas',
  'ws.playMp': '👥 A dos',
