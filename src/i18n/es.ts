...
export const es: Dict = {
  ...
  'promo.share': '📣 Corre la voz',
  'promo.title': 'tiltr – el laberinto invisible',
  'promo.text': 'Una bola, un laberinto invisible: oyes las paredes en vez de verlas. Ponte auriculares e inclina el móvil: el ping de eco te muestra el camino. Gratis en el navegador, jugable sin conexión y sin cuenta.',
  'promo.copied': 'Texto y enlace copiados 📋',
  ...
  'ed.together': 'Victoria coop',
  'ed.together.each': 'Cada uno por su lado',
  'ed.together.both': 'Llegar juntos',
  'ed.togetherHint': 'Solo se gana si ambos estáis en vuestras metas al mismo tiempo.',
  'ed.marks': 'Marcas por jugador',
  'ed.cols': 'Columnas',
  'ed.rows': 'Filas',
  'ed.reroll': 'Rebarajar laberinto',
  'ed.clearWalls': 'Borrar todos los muros',
  'ed.clearWallsAsk': '¿Borrar todos los muros?',
  'ed.clearedWalls': '{n} muros eliminados',
  ...
  'ed.f.latch': 'Tras abrirse',
  'ed.latch.close': 'se vuelve a cerrar',
  'ed.latch.stay': 'queda abierta',
  ...
  'ed.opensMin': 'Al menos una puerta',
  'ed.f.tune': 'Puerta sonora',
  ...
  'el.drain.title': 'Campo devorador',
  'el.drain.desc': 'Un campo que se come tus pings de eco: cada paso cuesta tantos como indica la cifra escrita encima, y volver a cruzarlo vuelve a costar. Aquí un atajo no cuesta tiempo, cuesta VISTA. Firma: una succión grave al acercarse y un tono descendente al pagar.',
  'st.drain': '🕳 Campo devorador: −{n} ping',
  'ed.f.drainCost': 'Coste (pings)',
  ...
  'ed.help.guards': 'Se puede pasar a cada guardia: una celda de su patrulla debe quedar libre. También cuenta un nicho de corrientes (dos corrientes que apuntan a una misma arista): allí la bola queda fijada en la junta, fuera del alcance de un guardián de las celdas vecinas. En rojo: sella el pasillo – añade un hueco o un paso transversal.',
  ...
  'hud.partnerWaits': '◎ Compañero esperando',
  'hud.mark': 'Dejar / recoger marca (m)',
  'hud.markEmpty': 'No queda ninguna marca: recoge una.',
  ...
  'mp.needsUpdate': 'Tu compañero necesita una versión más nueva de tiltr para este nivel.',
  ...
  'el.bell.desc': 'Pasa por encima y suena: un tañido claro que resuena cuatro segundos, y mientras dura, todos los escuchas corren hacia la campana en vez de hacia ti. Distraer en lugar de evitar. Respuesta al ping: un breve toque de campana. Entre dos suena para AMBOS: los oyentes del compañero también acuden.',
  ...
  'el.resonance.title': 'Campo de resonancia y dúo',
  'el.resonance.desc':
    'Una placa que sostiene la bola como un cuenco, y la inclinación se convierte en el mando de afinación: arriba la fundamental, abajo la quinta. Entre dos, los dos campos suenan uno contra otro; cuando el intervalo encaja (unísono o quinta), la puerta se abre. En solitario no se puede tocar.',
  ...
  'res.replay': '▶ Ver la partida',
  'st.replay': 'Repetición – la partida tal como fue',
  'res.cast': '🎬 Screencast',
  'cast.title': 'Screencast',
  'cast.text': 'El vídeo nace de la grabación: la partida se reproduce de nuevo y se captura con sonido – en tiempo real, es decir, tanto como duró. No salgas de la pantalla mientras tanto.',
  'cast.speed': 'Velocidad',
  'cast.light': 'Luz',
  'cast.asPlayed': 'como se jugó',
  'cast.bright': 'iluminado',
  'cast.go': '● Grabar',
  'cast.rec': '● REC',
  ...
  'cast.format': 'Formato',
  'cast.noAudio': '⚠ El archivo no tiene pista de audio ({diag}).',
  'cast.tryOther': 'Cambia el formato con ⚙ y graba de nuevo.',
  'cast.trackWord': 'pista(s)',
  ...
  'mp.partnerBell': '🔔 Tu compañero toca la campana: ¡los oyentes van hacia allí!',
  'mp.partnerTone': '🎵 Tu compañero está en su campo de resonancia.',
  'mp.partnerMark': '📍 Tu compañero ha dejado una marca.',
  'mp.partnerBoulder': '🪨 ¡Tu compañero empuja la piedra!',
  ...
  'mp.rendezvousTime': 'Llegasteis juntos tras {team}.',
