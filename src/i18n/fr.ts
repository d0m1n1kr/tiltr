...
export const fr: Dict = {
  ...
  'ed.opensMin': 'Au moins une porte',
  ...
  'el.drain.title': 'Champ vorace',
  'el.drain.desc': 'Un champ qui dévore tes pings d’écho : chaque passage coûte autant que le chiffre inscrit dessus – et repasser coûte de nouveau. Ici un raccourci ne coûte pas du temps, mais de la VUE. Signature : une aspiration grave à proximité, un son descendant qui aspire au moment de payer.',
  'st.drain': '🕳 Champ vorace : −{n} ping',
  'ed.f.drainCost': 'Coût (pings)',
  ...
  'res.replay': '▶ Revoir la course',
  'st.replay': 'Relecture – la course telle qu’elle était',
  'res.cast': '🎬 Screencast',
  'cast.title': 'Screencast',
  'cast.text': 'La vidéo naît de l’enregistrement : la course est rejouée et capturée avec le son – en temps réel, donc aussi longtemps qu’elle a duré. Ne quitte pas l’écran pendant ce temps.',
  'cast.speed': 'Vitesse',
  'cast.light': 'Lumière',
  'cast.asPlayed': 'comme joué',
  'cast.bright': 'éclairé',
  'cast.go': '● Enregistrer',
  'cast.rec': '● REC',
