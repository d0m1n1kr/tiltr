...
export const fr: Dict = {
  ...
  'ed.partner': 'Partenaire en aperçu',
  'ed.partner.holds': 'tient toutes les plaques',
  'ed.partner.none': 'absent',
  'st.partnerHolds': 'Aperçu : le partenaire tient toutes les plaques',
  'ws.playMp': '👥 À deux',
  'ws.mpMeta': '👥 2 joueurs',
